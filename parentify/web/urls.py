...
from parentify.web.views import home, login, register, logout, profile, settings, reference
...
urlpatterns = [
    ...
    re_path(r'^trecker/', include('parentify.web.trecker.urls')),
    re_path(r'^calendar/', include('parentify.web.calendar.urls')),
